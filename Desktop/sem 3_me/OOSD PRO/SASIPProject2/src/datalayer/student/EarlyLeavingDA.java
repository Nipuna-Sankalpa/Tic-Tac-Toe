...
//date has to be entered in leaving record.
    public static int addRecord(EarlyLeaveRecord record) throws SQLException, ClassNotFoundException, FileNotFoundException {
    ...
    public static int updateRecord(String studentID, String classID, String updatedReason, Date date) throws ClassNotFoundException, SQLException, FileNotFoundException {
        con = DBConnection.getConnection();
    ...
    public static int deleteRecord(int entry) throws ClassNotFoundException, SQLException {
    ...
    public static ResultSet searchRecord(String studentID, String classID, Date date) throws ClassNotFoundException, SQLException {
        con = DBConnection.getConnection();
        String temp = null;
