 ...
 * @author Mampitiya
 */
public class ClassManagement extends javax.swing.JDialog {

    private TutionController tutCont;
    /**
     * Creates new form RegisterNewClass
     */
    public ClassManagement(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(catCmbx, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        String id = yearTxt.getText() + catCmbx.getSelectedItem().toString();
        String category = catCmbx.getSelectedItem().toString();
        String year = yearTxt.getText();
        String day = dayCmbx.getSelectedItem().toString();
        Tution tution = new Tution(id, category, year, day);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ClassManagement dialog = new ClassManagement(new javax.swing.JFrame(), true);
